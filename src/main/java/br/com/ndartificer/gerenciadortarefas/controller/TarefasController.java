package br.com.ndartificer.gerenciadortarefas.controller;
...
import br.com.ndartificer.gerenciadortarefas.modelos.Tarefa;
import br.com.ndartificer.gerenciadortarefas.modelos.Usuario;
import br.com.ndartificer.gerenciadortarefas.repositorios.RepositorioTarefa;
import br.com.ndartificer.gerenciadortarefas.servicos.ServicoUsuario;
...
public class TarefasController {
	...
	public ModelAndView listar(HttpServletRequest request) {
		...
		mv.addObject("tarefas", repositorioTarefa.cerregarTarefasPorUsuario(emailUsuario));
		return mv;
	}
	...
	public ModelAndView alterar(@Valid Tarefa tarefa, BindingResult result) {
		...
		if (tarefa.getDataExpiracao() == null) {
			...
			if (tarefa.getDataExpiracao().before(new Date())) {
				result.rejectValue("dataExpiracao", "tarefa.dataExpiracaoInvalida",
						"A data de expiração não pode ser anterior ou igual a data atual!");
			}
		}
